...
export default function AboutPage() {
  return (
    <div className="min-h-screen bg-white text-black px-6 py-33 md:px-20">
      <h1 className="text-4xl md:text-5xl font-bold text-center mb-10 border-b border-black pb-4">  About Us </h1>

      <div className="max-w-4xl mx-auto space-y-6 text-lg leading-relaxed">
        <p>
          It all began with a pair of scissors and a dream. Hammad, known as “Ahmad”
          among his local clients in Dubai, stepped into the world of grooming nearly two
          decades ago. With nothing but a strong work ethic and a passion for style, he began
          shaping not just haircuts, but confidence.
        </p>
       ...
       <p>
          Today, Scissors VIP Salon stands as a blend of skill, experience, and ambition,
          a place where grooming is elevated, and every man walks out feeling confident,
          sharp, and seen.
        </p>
